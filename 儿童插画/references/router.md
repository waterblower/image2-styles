subject_routes:
  ...
  mixed: read only routes actually present in the request
material_routes:
...
Do not read face/full_body for an unmanned environment or an object. Stack only materials actually visible.
